...
class TaskBoardsControllerTest < ActionController::TestCase
  ...
  test "should create task_board" do
    assert_difference('TaskBoard.count') do
      post :create, task_board: { content: @task_board.content, create_time: @task_board.create_time, title: @task_board.title, user_id: @task_board.user_id }
    end
  ...
  test "should update task_board" do
    patch :update, id: @task_board, task_board: { content: @task_board.content, create_time: @task_board.create_time, title: @task_board.title, user_id: @task_board.user_id }
    assert_redirected_to task_board_path(assigns(:task_board))
  end
